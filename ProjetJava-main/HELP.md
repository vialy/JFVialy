...
* The following dependencies are not known to work with Spring Native: 'Spring Web Services, Spring Boot DevTools,
...
```
$ docker run --rm -p 8080:8080 SuperConcessionnaire2000:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/SuperConcessionnaire2000
```
